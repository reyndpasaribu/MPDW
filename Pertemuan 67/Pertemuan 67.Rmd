...
sehingga model tentafifnya ialah ARIMA(0,0,2) ARIMA(1,0,0), ARIMA(2,0,3)
...
### ARIMA (1,0,0)
```{r}
model2=Arima(dt.latih.ts, order=c(1,0,0),method="ML")
...
```
Penduga terbaik ialah aic terkecil dan parameter signifikan yang terdapat di ARIMA(0,0,2)
...
Berdasarkan uji KS tersebut, didapat *p-value* sebesar 9.647e-06 yang kurang dari taraf nyata 5% sehingga tolak $H_0$ dan menandakan bahwa sisaan tidak menyebar normal. Hal ini sesuai dengan hasil eksplorasi menggunakan plot kuantil-kuantil normal.
...
Berdasarkan uji Ljung-Box tersebut, didapat *p-value* sebesar 0.9769 yang lebih besar dari taraf nyata 5% sehingga tak tolak $H_0$ dan menandakan bahwa sisaan saling bebas. Artinya tidak ada autokorelasi
...
Berdasarkan uji Ljung-Box tersebut. didapat *p-value* sebesar 0.2189 yang lebih besar dari taraf nyata 5% sehingga tak tolak $H_0$ dan menandakan bahwa ragam sisaan homogen
...
Berdasarkan uji-ttersebut, didapat *p-value* sebesar 0.9464 yang lebih besar dari taraf nyata 5% sehingga tak tolak $H_0$ dan menandakan bahwa nilai tengah sisaan sama dengan 0
